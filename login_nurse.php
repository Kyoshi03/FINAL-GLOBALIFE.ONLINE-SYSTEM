    ...
    if (empty($username) || empty($password)) {
        ...
        if (login($username, $password)) {
            ...
            if ($user['role'] === 'doctor') {
                ...
                logout();
                $error = 'Access denied. This login is for clinic doctors only.';
            }
        } else {
...
$pageTitle = "Doctor Login | Globalife Medical Laboratory & Polyclinic";
$additionalStyles = '
    body {
    ...
    <div class="login-wrapper">
        <div class="login-container">
            <div class="login-header">
                ...
                <p class="login-subtitle">Sign in to review consultation appointments and patient records</p>
            </div>
